...
namespace CACSLibrary.Component
{
    ...
    public sealed class ChineseHelper
    {
        ...
        private static Regex regWord;
        private static Regex regNum;
        private static string[] strChineseCharList;
        static ChineseHelper()
        {
            ChineseHelper.regWord = new Regex("[a-zA-Z]");
            ChineseHelper.regNum = new Regex("[0-9]");
            ChineseHelper.strChineseCharList = new string[]
			{
				"Aa阿啊锕嗄厑哎哀唉埃挨溾锿鎄啀捱皑凒溰嘊敳皚癌毐昹嗳矮蔼躷噯藹譪霭靄艾伌爱砹硋隘嗌塧嫒愛碍暧瑷僾壒嬡懓薆曖璦鴱皧瞹馤鑀鱫安侒峖桉氨庵谙萻腤鹌蓭誝鞌鞍盦馣鮟盫韽啽雸垵",
				...
				"Cc嚓擦礤礸遪猜才材财財戝裁采倸埰婇寀彩採睬跴綵踩菜棌蔡縩乲参飡骖湌嬠餐驂残蚕惭殘慚蝅慙蠶蠺惨慘噆憯黪黲灿粲儏澯薒燦璨爘仓仺伧沧苍倉舱傖凔嵢滄獊蒼濸艙螥罉藏欌鑶賶撡操",
				...
				"Dd詫襜燀譂奲虰坘蚳赿跮揰裯儔幬篅搥錞踧吋咑哒耷畣搭嗒褡噠墶达妲怛垯炟羍荙匒笪答詚跶瘩靼薘鞑燵繨蟽躂鐽龖龘打大亣眔橽呆獃懛歹傣代汏轪侢垈岱帒甙绐迨带待怠柋殆玳贷帯軑埭",
				...
				"Ee娾砵妸妿娿屙讹囮迗俄娥峨峩涐莪珴訛皒睋鈋锇鹅蛾磀誐頟额額鵝鵞譌枙砈婀騀鵈厄歺戹阨呃扼苊阸呝砐轭咢垩峉匎恶砨蚅饿偔卾悪硆谔軛鄂阏堮崿愕湂萼豟軶遌遏廅搹琧腭僫蝁锷鹗蕚",
				"E遻頞颚餓噩擜覨諤餩鍔鳄歞顎櫮鰐鶚讍鑩齶鱷奀恩蒽峎摁鞥仒乻旕儿而侕陑峏洏荋栭胹袻鸸粫輀鲕隭髵鮞鴯轜尔耳迩洱饵栮毦珥铒餌駬薾邇趰二弍弐佴刵咡贰貮衈貳誀嗯唔诶",
				"Ff颰墢鼥韛朌頒報賁獖祊埄偪胇貶昞眪袚撥柭襏舩发沷発發彂髪橃醗乏伐姂垡疺罚阀栰傠筏瞂罰閥罸藅佱法砝鍅灋珐琺髮帆忛番勫噃墦嬏幡憣旙旛翻藩轓颿飜鱕凡凢凣匥杋柉矾籵钒舤烦舧",
				...
				"Gg玵閞鳺旮伽嘠钆尜嘎噶錷尕玍尬魀该陔垓姟峐荄晐赅畡祴該豥賅賌忋改絠鎅丐乢匃匄杚钙盖溉葢鈣戤概蓋槩槪漑瓂干甘芉迀杆玕肝坩泔苷柑竿疳酐粓亁凲尲尴筸漧尶尷魐皯秆衦赶敢笴稈",
				...
				"Hh餲淲豩豰俿腄墮吪魤犿浲侅郂絯忓攼仠桿汵榦臯鎬暠犵挌蛤厷愩唝羾詬鶻淈鹄鈷縎鵠怘趏潅雚洸襘鞼緄腘膕粿輠過铪丷哈嗨孩骸海胲烸塰酼醢亥骇害氦嗐餀駭駴嚡饚乤兯佄顸哻蚶酣頇谽",
				...
				"H耯藿蠖嚿曤臛癨矐鑊夻行砉圜",
				"Jj皀髉畟筴簎笒覘樔伡俥鋤雛處諔堲蠀覿茤岋紇裓構颳夬叏獷臩臦昋鱖妎悎饸紅鵍丌讥击刉叽饥乩刏圾机玑肌芨矶鸡枅咭迹剞唧姬屐积笄飢基绩喞嵆嵇犄筓缉赍勣嗘畸跻鳮僟箕銈嘰撃槣樭",
				...
				"Kk靠鮳鯌匼坷苛柯牁珂科胢轲疴趷钶嵙棵痾萪軻颏搕犐稞窠鈳榼薖颗樖瞌磕蝌頦醘顆髁礚壳咳翗嶱可岢炣渇嵑敤渴克刻剋勀勊客峇恪娔尅课堁氪骒缂嗑愙溘锞碦緙課錁礊騍肎肯肻垦恳啃豤",
				...
				"K韕懖霩鞹鬠穒",
				"Ll冫勑粚誺銐寵娕坔釘詻鄜膚鬴茖蛒鎘鉻羮篢睔腂蘫谾瘣暕撿諫倞靓靚牞摎樛畂寠窶垃拉柆啦翋菈邋旯砬揦磖喇藞嚹剌溂腊揧楋瘌蜡蝋辢辣蝲臈攋爉臘鬎櫴瓎镴鯻蠟鑞鞡来來俫倈崃徕涞莱",
				...
				"L摞漯犖雒駱鮥鵅纙鱳",
				"Mm絔硥苾牑訬仯哋尒尓爾坆呒撫羙秏狢貈貉湏惛殙貇氂犛厸龍龒嘸呣妈媽嬤嬷麻痲嫲蔴犘蟆蟇马犸玛码蚂馬溤獁遤瑪碼螞鎷鷌鰢亇杩祃閁骂唛傌睰嘜榪禡罵駡礣鬕吗嗎嘛埋霾买荬買嘪蕒鷶",
				...
				"Nn懝抝拗秅莀袲唸毭咹児兒耏聏峊廾嫨跈聻茮澆涳巙崀尦竜袮彌镾濔瀰乜樢拏拿誽镎鎿乸哪雫内那吶妠纳肭娜衲钠納袦捺笝豽軜貀嗱蒳靹魶腉熋孻乃奶艿氖疓妳廼迺倷釢嬭奈柰耐萘渿鼐褦",
				...
				"Oo吽摳噢哦筽夞乯鞰讴欧殴瓯鸥塸歐熰甌膒鴎櫙藲鏂鷗吘呕偶腢耦蕅藕怄沤慪漚",
				"Pp钯鈀跁罷猈螌褩闆湴牓棓徬鎊剝襃铇袌鉋鮑琲絣痭琣逬跰螕鎞粃枈痺辟稫箆鞞猵萹拚徧緶辯骉蔈颮麃藨謤穮驃驫摽汃砏璸鉼碆磻犻苩瓟桲淿湐猼馞嚗髆蚾獛鵏吥荹鈈郶茷籓膰趽彷衯夆馮",
				...
				"Qq摮磝朁鸧鶬鼜詧軙儭櫬趍袳創敠匚釓隑矼肐鉤扢琯矔鸛龜氿肣馯抲頜礉隺渹舙酄攲敧稘毄緝觭禨鄿鐖饑焏踖躤蟣済萕濟袷唊脥價靬鳒鰜鶼鑯揃葥漸摪彊勥焳燋湫湬蟜譑峤嶠潐噭椄疌倢偼",
				...
				"Rr吺兊兌熯卪坈繚髳挐鈉柟蟯臑抐內涊蹨孃菍莥獳檽蹃亽罖囕呥肰衻袇蚦袡蚺然髥嘫髯燃繎冄冉姌苒染珃媣蒅穣瀼獽禳瓤穰躟鬤壌嚷壤攘爙让懹譲讓荛饶桡橈襓饒犪扰娆隢擾绕遶繞惹热熱",
				...
				"R嵶蒻箬篛爇鰙鰯鶸",
				"Ss鉍灬杓攃偲纔參叄叅喰傪穇懆鄵拺笧粣鎈褨剎摻攙摌顫塲場綝乗娍匙飭埫醻敊猭漺輴縒棇楤漎憁缞縗鎝単單擔伔僤宲鍉遞遰挕阇闍陏蘴棴丨鞨咶鏸韢閄靃濈櫼帴菨嫅潏麗攦療蕯瀧氀稤蠰",
				...
				"Tt諳啚裧儃禪蟬繵閶瞋鐺珵侱漦爞綢籌俶埱蓴鶉鈶撘迏迖沓荅逹溚達鎉韃呔蚮軚貸癉撣嘾彈餤黨攩欓逿蕩簜蘯闣朷焘燾僜奃髢詆弚苐媂諦顚顛鈿调蓧啑惵趃奵忊墥峝湩詷钭鋀褍蜳橔囤庉憞",
				...
				"Uu辪癷袰蝊曢聣烪燞躼蒊蓞耂稥洜毜毝茒桛毮朑焽虲鶑鎼鐢艈霻闧焑屗歚徚鍂藔贘皼斏聁祍",
				"Ww趡惡噁唲陚龏萖関闗關貫窐姽恑瞶咼堝濄幠膴鋘譁瀤綄朚撝蒦嚄擭雘艧扝噲抂巋磈薶槾鄤澫堥夘呅韎雺霿沕忞鴖譕帓歾靺瞴蟱墲娒孯掔瓗渞蜹捼琞亠撱鰖屲劸哇娃徍挖洼娲畖窊媧嗗蛙搲",
				...
				"W窹霚鼿霧齀蘁騖鶩",
				"Xx欸庍壆扱烲愖糦臰欪滀嘼錯廗諜摡給蚼規嶲鮭巂鬹咁譀迒茠滈欱郃螛嗃熇燺揈閧闀闂鬨銗謼滸芐觟懁郇狟澴還镮鐶儶譮孈葷轋掝擊彐蔇縘繫夾埉浹傢裌叚徦鰔梘筧礆見閒瞯鵁轇驕絞較湝",
				...
				"X殾遜愻賐噀蕈顨鑂吁",
				"Yy叆賹礙譺靉菴媕葊痷闇鵪鶕晻洝媼澚墺驁頨瑒耛拸呾訑婸潒扚昳屵姶堊搤閼煾妋鳱輵夃焸蠱溎裷緷蟈淊嚛欥瓛輐喛揘韹熀袆煇褘蚘噦矆拁玪豜豣將侥烄僥伒莖俓泂揂圧僪貗飬妜焆鐍炏顑",
				...
				"Zz敱捗囃謲匨蔵冊側厠廁嶒扠挿揷蹅茝僝欃倀长仧長镸鼌鼂謿謓迧陳鈂趂朾脀憕徎胵絺泜歭遟遲迣徸漴褈緟蝩蟲紬搊椆詶薵偢芻鉏蕏傳鶨倕埀箠鎚純湻辶腏趠齱骴薋泚跐從蓯樅熜緫潀潈潨",
            ...
            ChineseHelper._pinyinHash = new Hashtable();
            ChineseHelper._pinyinHash.Add(-20319, "a");
            ChineseHelper._pinyinHash.Add(-20317, "ai");
            ChineseHelper._pinyinHash.Add(-20304, "an");
            ChineseHelper._pinyinHash.Add(-20295, "ang");
            ChineseHelper._pinyinHash.Add(-20292, "ao");
            ChineseHelper._pinyinHash.Add(-20283, "ba");
            ChineseHelper._pinyinHash.Add(-20265, "bai");
            ChineseHelper._pinyinHash.Add(-20257, "ban");
            ChineseHelper._pinyinHash.Add(-20242, "bang");
            ChineseHelper._pinyinHash.Add(-20230, "bao");
            ChineseHelper._pinyinHash.Add(-20051, "bei");
            ChineseHelper._pinyinHash.Add(-20036, "ben");
            ChineseHelper._pinyinHash.Add(-20032, "beng");
            ChineseHelper._pinyinHash.Add(-20026, "bi");
            ChineseHelper._pinyinHash.Add(-20002, "bian");
            ChineseHelper._pinyinHash.Add(-19990, "biao");
            ChineseHelper._pinyinHash.Add(-19986, "bie");
            ChineseHelper._pinyinHash.Add(-19982, "bin");
            ChineseHelper._pinyinHash.Add(-19976, "bing");
            ChineseHelper._pinyinHash.Add(-19805, "bo");
            ChineseHelper._pinyinHash.Add(-19784, "bu");
            ChineseHelper._pinyinHash.Add(-19775, "ca");
            ChineseHelper._pinyinHash.Add(-19774, "cai");
            ChineseHelper._pinyinHash.Add(-19763, "can");
            ChineseHelper._pinyinHash.Add(-19756, "cang");
            ChineseHelper._pinyinHash.Add(-19751, "cao");
            ChineseHelper._pinyinHash.Add(-19746, "ce");
            ChineseHelper._pinyinHash.Add(-19741, "ceng");
            ChineseHelper._pinyinHash.Add(-19739, "cha");
            ChineseHelper._pinyinHash.Add(-19728, "chai");
            ChineseHelper._pinyinHash.Add(-19725, "chan");
            ChineseHelper._pinyinHash.Add(-19715, "chang");
            ChineseHelper._pinyinHash.Add(-19540, "chao");
            ChineseHelper._pinyinHash.Add(-19531, "che");
            ChineseHelper._pinyinHash.Add(-19525, "chen");
            ChineseHelper._pinyinHash.Add(-19515, "cheng");
            ChineseHelper._pinyinHash.Add(-19500, "chi");
            ChineseHelper._pinyinHash.Add(-19484, "chong");
            ChineseHelper._pinyinHash.Add(-19479, "chou");
            ChineseHelper._pinyinHash.Add(-19467, "chu");
            ChineseHelper._pinyinHash.Add(-19289, "chuai");
            ChineseHelper._pinyinHash.Add(-19288, "chuan");
            ChineseHelper._pinyinHash.Add(-19281, "chuang");
            ChineseHelper._pinyinHash.Add(-19275, "chui");
            ChineseHelper._pinyinHash.Add(-19270, "chun");
            ChineseHelper._pinyinHash.Add(-19263, "chuo");
            ChineseHelper._pinyinHash.Add(-19261, "ci");
            ChineseHelper._pinyinHash.Add(-19249, "cong");
            ChineseHelper._pinyinHash.Add(-19243, "cou");
            ChineseHelper._pinyinHash.Add(-19242, "cu");
            ChineseHelper._pinyinHash.Add(-19238, "cuan");
            ChineseHelper._pinyinHash.Add(-19235, "cui");
            ChineseHelper._pinyinHash.Add(-19227, "cun");
            ChineseHelper._pinyinHash.Add(-19224, "cuo");
            ChineseHelper._pinyinHash.Add(-19218, "da");
            ChineseHelper._pinyinHash.Add(-19212, "dai");
            ChineseHelper._pinyinHash.Add(-19038, "dan");
            ChineseHelper._pinyinHash.Add(-19023, "dang");
            ChineseHelper._pinyinHash.Add(-19018, "dao");
            ChineseHelper._pinyinHash.Add(-19006, "de");
            ChineseHelper._pinyinHash.Add(-19003, "deng");
            ChineseHelper._pinyinHash.Add(-18996, "di");
            ChineseHelper._pinyinHash.Add(-18977, "dian");
            ChineseHelper._pinyinHash.Add(-18961, "diao");
            ChineseHelper._pinyinHash.Add(-18952, "die");
            ChineseHelper._pinyinHash.Add(-18783, "ding");
            ChineseHelper._pinyinHash.Add(-18774, "diu");
            ChineseHelper._pinyinHash.Add(-18773, "dong");
            ChineseHelper._pinyinHash.Add(-18763, "dou");
            ChineseHelper._pinyinHash.Add(-18756, "du");
            ChineseHelper._pinyinHash.Add(-18741, "duan");
            ChineseHelper._pinyinHash.Add(-18735, "dui");
            ChineseHelper._pinyinHash.Add(-18731, "dun");
            ChineseHelper._pinyinHash.Add(-18722, "duo");
            ChineseHelper._pinyinHash.Add(-18710, "e");
            ChineseHelper._pinyinHash.Add(-18697, "en");
            ChineseHelper._pinyinHash.Add(-18696, "er");
            ChineseHelper._pinyinHash.Add(-18526, "fa");
            ChineseHelper._pinyinHash.Add(-18518, "fan");
            ChineseHelper._pinyinHash.Add(-18501, "fang");
            ChineseHelper._pinyinHash.Add(-18490, "fei");
            ChineseHelper._pinyinHash.Add(-18478, "fen");
            ChineseHelper._pinyinHash.Add(-18463, "feng");
            ChineseHelper._pinyinHash.Add(-18448, "fo");
            ChineseHelper._pinyinHash.Add(-18447, "fou");
            ChineseHelper._pinyinHash.Add(-18446, "fu");
            ChineseHelper._pinyinHash.Add(-18239, "ga");
            ChineseHelper._pinyinHash.Add(-18237, "gai");
            ChineseHelper._pinyinHash.Add(-18231, "gan");
            ChineseHelper._pinyinHash.Add(-18220, "gang");
            ChineseHelper._pinyinHash.Add(-18211, "gao");
            ChineseHelper._pinyinHash.Add(-18201, "ge");
            ChineseHelper._pinyinHash.Add(-18184, "gei");
            ChineseHelper._pinyinHash.Add(-18183, "gen");
            ChineseHelper._pinyinHash.Add(-18181, "geng");
            ChineseHelper._pinyinHash.Add(-18012, "gong");
            ChineseHelper._pinyinHash.Add(-17997, "gou");
            ChineseHelper._pinyinHash.Add(-17988, "gu");
            ChineseHelper._pinyinHash.Add(-17970, "gua");
            ChineseHelper._pinyinHash.Add(-17964, "guai");
            ChineseHelper._pinyinHash.Add(-17961, "guan");
            ChineseHelper._pinyinHash.Add(-17950, "guang");
            ChineseHelper._pinyinHash.Add(-17947, "gui");
            ChineseHelper._pinyinHash.Add(-17931, "gun");
            ChineseHelper._pinyinHash.Add(-17928, "guo");
            ChineseHelper._pinyinHash.Add(-17922, "ha");
            ChineseHelper._pinyinHash.Add(-17759, "hai");
            ChineseHelper._pinyinHash.Add(-17752, "han");
            ChineseHelper._pinyinHash.Add(-17733, "hang");
            ChineseHelper._pinyinHash.Add(-17730, "hao");
            ChineseHelper._pinyinHash.Add(-17721, "he");
            ChineseHelper._pinyinHash.Add(-17703, "hei");
            ChineseHelper._pinyinHash.Add(-17701, "hen");
            ChineseHelper._pinyinHash.Add(-17697, "heng");
            ChineseHelper._pinyinHash.Add(-17692, "hong");
            ChineseHelper._pinyinHash.Add(-17683, "hou");
            ChineseHelper._pinyinHash.Add(-17676, "hu");
            ChineseHelper._pinyinHash.Add(-17496, "hua");
            ChineseHelper._pinyinHash.Add(-17487, "huai");
            ChineseHelper._pinyinHash.Add(-17482, "huan");
            ChineseHelper._pinyinHash.Add(-17468, "huang");
            ChineseHelper._pinyinHash.Add(-17454, "hui");
            ChineseHelper._pinyinHash.Add(-17433, "hun");
            ChineseHelper._pinyinHash.Add(-17427, "huo");
            ChineseHelper._pinyinHash.Add(-17417, "ji");
            ChineseHelper._pinyinHash.Add(-17202, "jia");
            ChineseHelper._pinyinHash.Add(-17185, "jian");
            ChineseHelper._pinyinHash.Add(-16983, "jiang");
            ChineseHelper._pinyinHash.Add(-16970, "jiao");
            ChineseHelper._pinyinHash.Add(-16942, "jie");
            ChineseHelper._pinyinHash.Add(-16915, "jin");
            ChineseHelper._pinyinHash.Add(-16733, "jing");
            ChineseHelper._pinyinHash.Add(-16708, "jiong");
            ChineseHelper._pinyinHash.Add(-16706, "jiu");
            ChineseHelper._pinyinHash.Add(-16689, "ju");
            ChineseHelper._pinyinHash.Add(-16664, "juan");
            ChineseHelper._pinyinHash.Add(-16657, "jue");
            ChineseHelper._pinyinHash.Add(-16647, "jun");
            ChineseHelper._pinyinHash.Add(-16474, "ka");
            ChineseHelper._pinyinHash.Add(-16470, "kai");
            ChineseHelper._pinyinHash.Add(-16465, "kan");
            ChineseHelper._pinyinHash.Add(-16459, "kang");
            ChineseHelper._pinyinHash.Add(-16452, "kao");
            ChineseHelper._pinyinHash.Add(-16448, "ke");
            ChineseHelper._pinyinHash.Add(-16433, "ken");
            ChineseHelper._pinyinHash.Add(-16429, "keng");
            ChineseHelper._pinyinHash.Add(-16427, "kong");
            ChineseHelper._pinyinHash.Add(-16423, "kou");
            ChineseHelper._pinyinHash.Add(-16419, "ku");
            ChineseHelper._pinyinHash.Add(-16412, "kua");
            ChineseHelper._pinyinHash.Add(-16407, "kuai");
            ChineseHelper._pinyinHash.Add(-16403, "kuan");
            ChineseHelper._pinyinHash.Add(-16401, "kuang");
            ChineseHelper._pinyinHash.Add(-16393, "kui");
            ChineseHelper._pinyinHash.Add(-16220, "kun");
            ChineseHelper._pinyinHash.Add(-16216, "kuo");
            ChineseHelper._pinyinHash.Add(-16212, "la");
            ChineseHelper._pinyinHash.Add(-16205, "lai");
            ChineseHelper._pinyinHash.Add(-16202, "lan");
            ChineseHelper._pinyinHash.Add(-16187, "lang");
            ChineseHelper._pinyinHash.Add(-16180, "lao");
            ChineseHelper._pinyinHash.Add(-16171, "le");
            ChineseHelper._pinyinHash.Add(-16169, "lei");
            ChineseHelper._pinyinHash.Add(-16158, "leng");
            ChineseHelper._pinyinHash.Add(-16155, "li");
            ChineseHelper._pinyinHash.Add(-15959, "lia");
            ChineseHelper._pinyinHash.Add(-15958, "lian");
            ChineseHelper._pinyinHash.Add(-15944, "liang");
            ChineseHelper._pinyinHash.Add(-15933, "liao");
            ChineseHelper._pinyinHash.Add(-15920, "lie");
            ChineseHelper._pinyinHash.Add(-15915, "lin");
            ChineseHelper._pinyinHash.Add(-15903, "ling");
            ChineseHelper._pinyinHash.Add(-15889, "liu");
            ChineseHelper._pinyinHash.Add(-15878, "long");
            ChineseHelper._pinyinHash.Add(-15707, "lou");
            ChineseHelper._pinyinHash.Add(-15701, "lu");
            ChineseHelper._pinyinHash.Add(-15681, "lv");
            ChineseHelper._pinyinHash.Add(-15667, "luan");
            ChineseHelper._pinyinHash.Add(-15661, "lue");
            ChineseHelper._pinyinHash.Add(-15659, "lun");
            ChineseHelper._pinyinHash.Add(-15652, "luo");
            ChineseHelper._pinyinHash.Add(-15640, "ma");
            ChineseHelper._pinyinHash.Add(-15631, "mai");
            ChineseHelper._pinyinHash.Add(-15625, "man");
            ChineseHelper._pinyinHash.Add(-15454, "mang");
            ChineseHelper._pinyinHash.Add(-15448, "mao");
            ChineseHelper._pinyinHash.Add(-15436, "me");
            ChineseHelper._pinyinHash.Add(-15435, "mei");
            ChineseHelper._pinyinHash.Add(-15419, "men");
            ChineseHelper._pinyinHash.Add(-15416, "meng");
            ChineseHelper._pinyinHash.Add(-15408, "mi");
            ChineseHelper._pinyinHash.Add(-15394, "mian");
            ChineseHelper._pinyinHash.Add(-15385, "miao");
            ChineseHelper._pinyinHash.Add(-15377, "mie");
            ChineseHelper._pinyinHash.Add(-15375, "min");
            ChineseHelper._pinyinHash.Add(-15369, "ming");
            ChineseHelper._pinyinHash.Add(-15363, "miu");
            ChineseHelper._pinyinHash.Add(-15362, "mo");
            ChineseHelper._pinyinHash.Add(-15183, "mou");
            ChineseHelper._pinyinHash.Add(-15180, "mu");
            ChineseHelper._pinyinHash.Add(-15165, "na");
            ChineseHelper._pinyinHash.Add(-15158, "nai");
            ChineseHelper._pinyinHash.Add(-15153, "nan");
            ChineseHelper._pinyinHash.Add(-15150, "nang");
            ChineseHelper._pinyinHash.Add(-15149, "nao");
            ChineseHelper._pinyinHash.Add(-15144, "ne");
            ChineseHelper._pinyinHash.Add(-15143, "nei");
            ChineseHelper._pinyinHash.Add(-15141, "nen");
            ChineseHelper._pinyinHash.Add(-15140, "neng");
            ChineseHelper._pinyinHash.Add(-15139, "ni");
            ChineseHelper._pinyinHash.Add(-15128, "nian");
            ChineseHelper._pinyinHash.Add(-15121, "niang");
            ChineseHelper._pinyinHash.Add(-15119, "niao");
            ChineseHelper._pinyinHash.Add(-15117, "nie");
            ChineseHelper._pinyinHash.Add(-15110, "nin");
            ChineseHelper._pinyinHash.Add(-15109, "ning");
            ChineseHelper._pinyinHash.Add(-14941, "niu");
            ChineseHelper._pinyinHash.Add(-14937, "nong");
            ChineseHelper._pinyinHash.Add(-14933, "nu");
            ChineseHelper._pinyinHash.Add(-14930, "nv");
            ChineseHelper._pinyinHash.Add(-14929, "nuan");
            ChineseHelper._pinyinHash.Add(-14928, "nue");
            ChineseHelper._pinyinHash.Add(-14926, "nuo");
            ChineseHelper._pinyinHash.Add(-14922, "o");
            ChineseHelper._pinyinHash.Add(-14921, "ou");
            ChineseHelper._pinyinHash.Add(-14914, "pa");
            ChineseHelper._pinyinHash.Add(-14908, "pai");
            ChineseHelper._pinyinHash.Add(-14902, "pan");
            ChineseHelper._pinyinHash.Add(-14894, "pang");
            ChineseHelper._pinyinHash.Add(-14889, "pao");
            ChineseHelper._pinyinHash.Add(-14882, "pei");
            ChineseHelper._pinyinHash.Add(-14873, "pen");
            ChineseHelper._pinyinHash.Add(-14871, "peng");
            ChineseHelper._pinyinHash.Add(-14857, "pi");
            ChineseHelper._pinyinHash.Add(-14678, "pian");
            ChineseHelper._pinyinHash.Add(-14674, "piao");
            ChineseHelper._pinyinHash.Add(-14670, "pie");
            ChineseHelper._pinyinHash.Add(-14668, "pin");
            ChineseHelper._pinyinHash.Add(-14663, "ping");
            ChineseHelper._pinyinHash.Add(-14654, "po");
            ChineseHelper._pinyinHash.Add(-14645, "pu");
            ChineseHelper._pinyinHash.Add(-14630, "qi");
            ChineseHelper._pinyinHash.Add(-14594, "qia");
            ChineseHelper._pinyinHash.Add(-14429, "qian");
            ChineseHelper._pinyinHash.Add(-14407, "qiang");
            ChineseHelper._pinyinHash.Add(-14399, "qiao");
            ChineseHelper._pinyinHash.Add(-14384, "qie");
            ChineseHelper._pinyinHash.Add(-14379, "qin");
            ChineseHelper._pinyinHash.Add(-14368, "qing");
            ChineseHelper._pinyinHash.Add(-14355, "qiong");
            ChineseHelper._pinyinHash.Add(-14353, "qiu");
            ChineseHelper._pinyinHash.Add(-14345, "qu");
            ChineseHelper._pinyinHash.Add(-14170, "quan");
            ChineseHelper._pinyinHash.Add(-14159, "que");
            ChineseHelper._pinyinHash.Add(-14151, "qun");
            ChineseHelper._pinyinHash.Add(-14149, "ran");
            ChineseHelper._pinyinHash.Add(-14145, "rang");
            ChineseHelper._pinyinHash.Add(-14140, "rao");
            ChineseHelper._pinyinHash.Add(-14137, "re");
            ChineseHelper._pinyinHash.Add(-14135, "ren");
            ChineseHelper._pinyinHash.Add(-14125, "reng");
            ChineseHelper._pinyinHash.Add(-14123, "ri");
            ChineseHelper._pinyinHash.Add(-14122, "rong");
            ChineseHelper._pinyinHash.Add(-14112, "rou");
            ChineseHelper._pinyinHash.Add(-14109, "ru");
            ChineseHelper._pinyinHash.Add(-14099, "ruan");
            ChineseHelper._pinyinHash.Add(-14097, "rui");
            ChineseHelper._pinyinHash.Add(-14094, "run");
            ChineseHelper._pinyinHash.Add(-14092, "ruo");
            ChineseHelper._pinyinHash.Add(-14090, "sa");
            ChineseHelper._pinyinHash.Add(-14087, "sai");
            ChineseHelper._pinyinHash.Add(-14083, "san");
            ChineseHelper._pinyinHash.Add(-13917, "sang");
            ChineseHelper._pinyinHash.Add(-13914, "sao");
            ChineseHelper._pinyinHash.Add(-13910, "se");
            ChineseHelper._pinyinHash.Add(-13907, "sen");
            ChineseHelper._pinyinHash.Add(-13906, "seng");
            ChineseHelper._pinyinHash.Add(-13905, "sha");
            ChineseHelper._pinyinHash.Add(-13896, "shai");
            ChineseHelper._pinyinHash.Add(-13894, "shan");
            ChineseHelper._pinyinHash.Add(-13878, "shang");
            ChineseHelper._pinyinHash.Add(-13870, "shao");
            ChineseHelper._pinyinHash.Add(-13859, "she");
            ChineseHelper._pinyinHash.Add(-13847, "shen");
            ChineseHelper._pinyinHash.Add(-13831, "sheng");
            ChineseHelper._pinyinHash.Add(-13658, "shi");
            ChineseHelper._pinyinHash.Add(-13611, "shou");
            ChineseHelper._pinyinHash.Add(-13601, "shu");
            ChineseHelper._pinyinHash.Add(-13406, "shua");
            ChineseHelper._pinyinHash.Add(-13404, "shuai");
            ChineseHelper._pinyinHash.Add(-13400, "shuan");
            ChineseHelper._pinyinHash.Add(-13398, "shuang");
            ChineseHelper._pinyinHash.Add(-13395, "shui");
            ChineseHelper._pinyinHash.Add(-13391, "shun");
            ChineseHelper._pinyinHash.Add(-13387, "shuo");
            ChineseHelper._pinyinHash.Add(-13383, "si");
            ChineseHelper._pinyinHash.Add(-13367, "song");
            ChineseHelper._pinyinHash.Add(-13359, "sou");
            ChineseHelper._pinyinHash.Add(-13356, "su");
            ChineseHelper._pinyinHash.Add(-13343, "suan");
            ChineseHelper._pinyinHash.Add(-13340, "sui");
            ChineseHelper._pinyinHash.Add(-13329, "sun");
            ChineseHelper._pinyinHash.Add(-13326, "suo");
            ChineseHelper._pinyinHash.Add(-13318, "ta");
            ChineseHelper._pinyinHash.Add(-13147, "tai");
            ChineseHelper._pinyinHash.Add(-13138, "tan");
            ChineseHelper._pinyinHash.Add(-13120, "tang");
            ChineseHelper._pinyinHash.Add(-13107, "tao");
            ChineseHelper._pinyinHash.Add(-13096, "te");
            ChineseHelper._pinyinHash.Add(-13095, "teng");
            ChineseHelper._pinyinHash.Add(-13091, "ti");
            ChineseHelper._pinyinHash.Add(-13076, "tian");
            ChineseHelper._pinyinHash.Add(-13068, "tiao");
            ChineseHelper._pinyinHash.Add(-13063, "tie");
            ChineseHelper._pinyinHash.Add(-13060, "ting");
            ChineseHelper._pinyinHash.Add(-12888, "tong");
            ChineseHelper._pinyinHash.Add(-12875, "tou");
            ChineseHelper._pinyinHash.Add(-12871, "tu");
            ChineseHelper._pinyinHash.Add(-12860, "tuan");
            ChineseHelper._pinyinHash.Add(-12858, "tui");
            ChineseHelper._pinyinHash.Add(-12852, "tun");
            ChineseHelper._pinyinHash.Add(-12849, "tuo");
            ChineseHelper._pinyinHash.Add(-12838, "wa");
            ChineseHelper._pinyinHash.Add(-12831, "wai");
            ChineseHelper._pinyinHash.Add(-12829, "wan");
            ChineseHelper._pinyinHash.Add(-12812, "wang");
            ChineseHelper._pinyinHash.Add(-12802, "wei");
            ChineseHelper._pinyinHash.Add(-12607, "wen");
            ChineseHelper._pinyinHash.Add(-12597, "weng");
            ChineseHelper._pinyinHash.Add(-12594, "wo");
            ChineseHelper._pinyinHash.Add(-12585, "wu");
            ChineseHelper._pinyinHash.Add(-12556, "xi");
            ChineseHelper._pinyinHash.Add(-12359, "xia");
            ChineseHelper._pinyinHash.Add(-12346, "xian");
            ChineseHelper._pinyinHash.Add(-12320, "xiang");
            ChineseHelper._pinyinHash.Add(-12300, "xiao");
            ChineseHelper._pinyinHash.Add(-12120, "xie");
            ChineseHelper._pinyinHash.Add(-12099, "xin");
            ChineseHelper._pinyinHash.Add(-12089, "xing");
            ChineseHelper._pinyinHash.Add(-12074, "xiong");
            ChineseHelper._pinyinHash.Add(-12067, "xiu");
            ChineseHelper._pinyinHash.Add(-12058, "xu");
            ChineseHelper._pinyinHash.Add(-12039, "xuan");
            ChineseHelper._pinyinHash.Add(-11867, "xue");
            ChineseHelper._pinyinHash.Add(-11861, "xun");
            ChineseHelper._pinyinHash.Add(-11847, "ya");
            ChineseHelper._pinyinHash.Add(-11831, "yan");
            ChineseHelper._pinyinHash.Add(-11798, "yang");
            ChineseHelper._pinyinHash.Add(-11781, "yao");
            ChineseHelper._pinyinHash.Add(-11604, "ye");
            ChineseHelper._pinyinHash.Add(-11589, "yi");
            ChineseHelper._pinyinHash.Add(-11536, "yin");
            ChineseHelper._pinyinHash.Add(-11358, "ying");
            ChineseHelper._pinyinHash.Add(-11340, "yo");
            ChineseHelper._pinyinHash.Add(-11339, "yong");
            ChineseHelper._pinyinHash.Add(-11324, "you");
            ChineseHelper._pinyinHash.Add(-11303, "yu");
            ChineseHelper._pinyinHash.Add(-11097, "yuan");
            ChineseHelper._pinyinHash.Add(-11077, "yue");
            ChineseHelper._pinyinHash.Add(-11067, "yun");
            ChineseHelper._pinyinHash.Add(-11055, "za");
            ChineseHelper._pinyinHash.Add(-11052, "zai");
            ChineseHelper._pinyinHash.Add(-11045, "zan");
            ChineseHelper._pinyinHash.Add(-11041, "zang");
            ChineseHelper._pinyinHash.Add(-11038, "zao");
            ChineseHelper._pinyinHash.Add(-11024, "ze");
            ChineseHelper._pinyinHash.Add(-11020, "zei");
            ChineseHelper._pinyinHash.Add(-11019, "zen");
            ChineseHelper._pinyinHash.Add(-11018, "zeng");
            ChineseHelper._pinyinHash.Add(-11014, "zha");
            ChineseHelper._pinyinHash.Add(-10838, "zhai");
            ChineseHelper._pinyinHash.Add(-10832, "zhan");
            ChineseHelper._pinyinHash.Add(-10815, "zhang");
            ChineseHelper._pinyinHash.Add(-10800, "zhao");
            ChineseHelper._pinyinHash.Add(-10790, "zhe");
            ChineseHelper._pinyinHash.Add(-10780, "zhen");
            ChineseHelper._pinyinHash.Add(-10764, "zheng");
            ChineseHelper._pinyinHash.Add(-10587, "zhi");
            ChineseHelper._pinyinHash.Add(-10544, "zhong");
            ChineseHelper._pinyinHash.Add(-10533, "zhou");
            ChineseHelper._pinyinHash.Add(-10519, "zhu");
            ChineseHelper._pinyinHash.Add(-10331, "zhua");
            ChineseHelper._pinyinHash.Add(-10329, "zhuai");
            ChineseHelper._pinyinHash.Add(-10328, "zhuan");
            ChineseHelper._pinyinHash.Add(-10322, "zhuang");
            ChineseHelper._pinyinHash.Add(-10315, "zhui");
            ChineseHelper._pinyinHash.Add(-10309, "zhun");
            ChineseHelper._pinyinHash.Add(-10307, "zhuo");
            ChineseHelper._pinyinHash.Add(-10296, "zi");
            ChineseHelper._pinyinHash.Add(-10281, "zong");
            ChineseHelper._pinyinHash.Add(-10274, "zou");
            ChineseHelper._pinyinHash.Add(-10270, "zu");
            ChineseHelper._pinyinHash.Add(-10262, "zuan");
            ChineseHelper._pinyinHash.Add(-10260, "zui");
            ChineseHelper._pinyinHash.Add(-10256, "zun");
            ChineseHelper._pinyinHash.Add(-10254, "zuo");
            ChineseHelper._pinyinHash.Add(-10247, "zz");
        }

        /// <summary>
        /// 文字装换成拼音
        /// </summary>
        /// <param name="chineseChars">文字</param>
        /// <returns>拼音</returns>
        public static string GetPinyin(string chineseChars)
        {
            byte[] bytes = Encoding.Default.GetBytes(chineseChars);
            StringBuilder stringBuilder = new StringBuilder(chineseChars.Length * 4);
            for (int i = 0; i < bytes.Length; i++)
            {
                ...
                if (num > 160)
                {
                    ...
                    stringBuilder.Append(ChineseHelper.GetPinyin(num));
                }
                else
                {
        ...
        public static string GetShortPinyin(string chineseChars)
        {
            ...
            for (int i = 0; i < bytes.Length; i++)
            {
                ...
                if (num > 160)
                {
                    ...
                    num = num * 256 + (int)bytes[i] - 65536;
                    string text = ChineseHelper.GetPinyin(num);
        ...
        private static string GetPinyin(int charValue)
        {
            ...
            while (!ChineseHelper._pinyinHash.ContainsKey(charValue))
            {
                charValue--;
            }
            return (string)ChineseHelper._pinyinHash[charValue];
        }

        /// <summary>
        /// 获得词组的拼音简称
        /// </summary>
        /// <param name="pingyin">文字</param>
        /// <returns>拼音</returns>
        public static string GetFirstWord(string pingyin)
        {
            ...
            {
                text = pingyin.Substring(i, 1);
                if (ChineseHelper.regWord.IsMatch(text))
                {
                    break;
                }
                if (ChineseHelper.regNum.IsMatch(text))
                {
                    if (text == "0")
                    {
                        text = "l";
        ...
        public static string GetChineseSpell(string strText)
        {
            ...
            for (int i = 0; i < strText.Length; i++)
            {
                ...
                else
                {
                    if (c >= '一' && c <= '龥')
                    {
                        string[] array = ChineseHelper.strChineseCharList;
        ...
        /// <param name="strText"></param>
        /// <returns></returns>
        public static char[] GetChineseSpellArray(string strText)
        {
        ...
        /// <returns></returns>
        public static string[] GetChineseChars(char charText)
        {
            List<string> list = new List<string>();
            if ((charText >= 'a' && charText <= 'z') || (charText >= 'A' && charText <= 'Z'))
            {
                charText = char.ToUpper(charText);
                string[] array = ChineseHelper.strChineseCharList;
                for (int i = 0; i < array.Length; i++)
                {
                    string text = array[i];
                    if (text.StartsWith(charText.ToString()))
                    {
                        list.AddRange(
                            from m in text.ToCharArray()
                            select m.ToString());
                    }
                }
            }
